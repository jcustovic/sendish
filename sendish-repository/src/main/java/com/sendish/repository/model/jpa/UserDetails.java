...
public class UserDetails implements Serializable, LocationAware {
    ...
    @Column(name = "aud_come_back_reminder_time")
    @Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTime")
    private DateTime comeBackReminderTime;
    ...
    public DateTime getComeBackReminderTime() {
        return comeBackReminderTime;
    }

    public void setComeBackReminderTime(DateTime comeBackReminderTime) {
        this.comeBackReminderTime = comeBackReminderTime;
    }
